...
**Bulgu 15 — Gerçek EVREN anahtarıyla ilk kez ölçüldü: bge-m3-embed, bu projenin Türkçe korpusunda yerel e5-base'in ALTINDA kaldı (ADR 0002'nin varsayımıyla çelişiyor).**
...
**Bulgu 16 — `banka_ve_konu` ve `dogal_soru`'nun düşük Recall'unun kök nedeni araştırıldı: çoğunlukla retrieval hatası değil, korpustaki YAKIN-DUPLİKAT kampanyalar.**
