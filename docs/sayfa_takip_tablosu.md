...
| Albaraka Türk | Kampanya detayları (11 sayfa) | — | `.../kampanyalar/detay/*` | HTML | 200 | Hayır | 11 başarılı | `.searchContent` seçicisi doğrulandı (rapor Bölüm 3'teki "Kâr payı yok. Beklemek yok." örneği bu sayfada bulundu) |
